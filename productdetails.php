                                          ...
                                          if (empty ($options)) {
                                            ...
                                            foreach ($options as $option) {
                                              if (!empty ($option['unit_name']) && !in_array($option['unit_name'], $size_names)) {
                                                ...
                                                echo '<div style="background-color: #FDF8F8;   width: 50px; display:flex; justify-content: center; margin-right: 5px; border-radius: 2px;"><label class="form-check-label" for="size' . $option['stocks_unit_id'] . '">' . $option['unit_name'] . '</label>';
                                                echo '</div></div>';
                                              }
                                            }
                                          }
                                  ...
                                  if (empty ($options)) {
                                    ...
                                    foreach ($options as $option) {
                                      if (!empty ($option['color_name']) && !in_array($option['color_name'], $color_names)) {
                                        ...
                                        echo '<div  style="background-color: #FDF8F8;   width: 50px; display:flex; justify-content: center; margin-right: 5px; border-radius: 5px;"><label class="form-check-label" for="color' . $option['stocks_color_id'] . '">' . $option['color_name'] . '</label>';
                                        echo '</div></div>';
                                      }
                                    }
                                  }
                                          ...
                                          if (empty ($options)) {
                                            ...
                                            foreach ($options as $option) {
                                              if (!empty ($option['unit_name']) && !in_array($option['unit_name'], $size_names)) {
                                                ...
                                                echo ' <div class ="form-check" >';
                                                echo '<input class="form-check-input" type="radio" name="size" id="size' . $option['stocks_unit_id'] . '" value="' . $option['unit_name'] . '" required>';
                                                echo '<div  style="background-color:#FDF8F8; display:flex; justify-content: center; margin-right: 5px; border-radius: 5px;"><label class="form-check-label" for="size' . $option['stocks_unit_id'] . '">' . $option['unit_name'] . '</label>';
                                                echo '</div></div>';
                                              }
                                            }
                                          }
                                  ...
                                  if (empty ($options)) {
                                    ...
                                    foreach ($options as $option) {
                                      if (!empty ($option['color_name']) && !in_array($option['color_name'], $color_names)) {
                                        ...
                                        echo '<div class="form-check">';
                                        echo '<input class="form-check-input" type="radio" name="color" id="color' . $option['stocks_color_id'] . '" value="' . $option['color_name'] . '" required>';
                                        echo '<div style="background-color:#FDF8F8;    display:flex; justify-content: center; margin-right: 5px; border-radius: 5px;"><label class="form-check-label" for="color' . $option['stocks_color_id'] . '">' . $option['color_name'] . '</label>';
                                        echo '</div></div>';
                                      }
                                    }
                                  }
