                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <div class="input-group-append">
                                                                                <input type="submit" value="&#x2713;"
                                                                                    name="update_product_name" class="btn btn-dark">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm">
                                                                        <div class="input-group mb-3">
                                                                            ...
                                                                            <div class="input-group-append">
                                                                                <input type="submit" value="&#x2713;"
                                                                                    name="update_price" class="btn btn-dark">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm">
                                                                        ...
                                                                        <input style="margin-bottom: 20px;" type="submit"
                                                                            value="UPDATE MAIN IMAGE" name="update_image"
                                                                            class="btn btn-dark">
                                                                    </div>
                                                                    ...
                                                                    <div class="col-sm">
                                                                        ...
                                                                        <input type="submit" value="UPLOAD TO GALLERY"
                                                                            name="upload_image" class="btn btn-dark">
