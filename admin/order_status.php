                                        ...
                                        <tr>
                                            <td>
                                                <div style="display: flex; flex-direction: column; align-items: center;">
                                                    <a class="btn detail-btn" style="width: 100%;" href="order_status.php?ship=<?= htmlspecialchars($row['id']) ?>">
                                                        Ship
                                                    </a>
                                                    <br>
                                                    <a class="btn detail-btn" style="width: 100%;" href="order_status.php?receive=<?= htmlspecialchars($row['id']) ?>">
                                                        Receive
                                                    </a>
                                                    <br>
                                                    <a href="order_status.php?complete=<?= htmlspecialchars($row['id']); ?>" class="btn detail-btn" style="width: 100%;">
                                                        <i class="fas "></i> Complete
                                                    </a>
                                                    <br>
                                                    <a href="order_status.php?delete=<?= htmlspecialchars($row['id']); ?>" class="btn btn-danger" style="width: 100%;">
                                            ...
                                            <td>
                                                ...
                                                <br>
                                                <br>
                                                <img style="width: 200px; height: 150px;" src="./uploaded_img/<?= $row['screenshot'] ?>" alt="Image" class="img-fluid">
                                            </td>
