            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 offset-md-4 form">
                        ...
                        <form action="register_form.php" method="POST" autocomplete="">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control submit_button" style="color: white;" type="submit" name="signup" value="SIGN UP">
                            </div>
                            <div class="link login-link text-center">Already have an account? <a href="login_form.php" style="color: #BB4D00;">Login here.</a></div>
