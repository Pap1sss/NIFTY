         ...
         <form action="" method="post" enctype="multipart/form-data">
            ...
            <div style="box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.20);">
               <ul class="list-group" style="margin-top: 20px;" style="">
                  ...
                  <li class="list-group-item d-flex justify-content-center">
                     <input type="text" placeholder="Business Description" name="description" class="box" style="width: 80%;">
                  ...
                  <li class="list-group-item d-flex justify-content-center">
                     <input type="text" placeholder="Business Address" name="company_address" class="box" style="width: 80%;">
                     <input type="submit" value="&#x2713;" name="update_business_address" class="btn detail-btn">
                  </li>
                  <li class="list-group-item d-flex justify-content-center">
                     <input type="tel" placeholder="Business Contact number" name="company_contact" class="box" style="width: 80%;">
                  ...
                  <li class="list-group-item" style="text-align: center;">
                     ...
                     <input type="submit" value="Upload Logo" name="update_business_logo" class="btn detail-btn" style="border-radius:20px">
                  </li>
                  ...
                  <li class="list-group-item" style="text-align: center;">
                     ...
                     <input type="submit" value="Upload Home Image" name="update_business_home" class="btn detail-btn" style="border-radius:20px">
                  </li>
                  <li class="list-group-item" style="text-align: center;">
                     ...
                     <input type="submit" value="Upload GCASH QR" name="update_business_gcash" class="btn detail-btn" style="border-radius:20px">
                  </li>
            ...
            ?>
               ...
               <table class="table table-bordered border-primary">
                  ...
                  <tr>
                     ...
                     <td style="border: 1px solid black;">
                        <img src="uploaded_img/<?php echo htmlspecialchars($row['homepage_image']); ?>" width="150" alt="logo">
                     </td>
                     <td style="border: 1px solid black;">
