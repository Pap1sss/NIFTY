        ...
        <div class="card mb-4">
          <div class="card-body">
            ...
            <hr>
                        ...
                        <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex align-items-center">
                                        <input type="tel" class="form-control flex-grow-1 mr-2" id="contact" name ="contact" value="<?php echo htmlspecialchars($contact); ?>" maxlength="11" pattern="[0-9]{11}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <div class="d-flex align-items-center">
                                        <textarea class="form-control flex-grow-1 mr-2" id="address" name ="address" rows="3" ><?php echo htmlspecialchars($address); ?></textarea>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <button type="submit" name = "submit" class="btn btn-primary btn-block" style = "display: inline-block;">Update Information</button>
