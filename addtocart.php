<?php
session_start();
include('login_user/includes/config.php');
include('login_user/includes/db.php');
include('login_user/includes/functions.php');
if(!loggedIn()){
...
<head>
    ...
    <style>
        ...
        .product{
            border: 1px solid rgb(237, 200, 157);
        ...
        .title2{
            text-align: center;
            color: white;
            background-color: rgb(237, 200, 157);
            padding: 2%;
        }
        h2{
            text-align: center;
                ...
                if(!empty($_SESSION["addtocart"])){
                    ...
                    foreach ($_SESSION["addtocart"] as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><a href="addtocart.php?action=delete&id=<?php echo $value["product_id"]; ?>"><span
